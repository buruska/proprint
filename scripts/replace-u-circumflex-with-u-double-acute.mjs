...
function replaceInValue(value) {
  if (typeof value === "string") {
    const nextValue = value.replace(/û/g, "ű");

    return {
      value: nextValue,
      replacements: value === nextValue ? 0 : (value.match(/û/g) ?? []).length,
...
async function replaceCircumflexUInDatabase() {
